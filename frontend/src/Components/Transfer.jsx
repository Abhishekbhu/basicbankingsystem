...
function TransferPage() {
  ...
  const transfermoney = ()=>
  {
    ...
    axios
        .post("http://localhost:8000/transfermoney", { senderacno: senderid , receivername , receiveracno ,amount}) // Put the request body inside the parentheses
        .then((response) => {
  ...
  useEffect(() => {
    ...
    if (id) {
      ...
      axios
        .post("http://localhost:8000/findcustomer", { accountno: id }) // Put the request body inside the parentheses
        .then((response) => {
